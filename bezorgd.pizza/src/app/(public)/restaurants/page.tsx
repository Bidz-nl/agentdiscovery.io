  ...
  return (
    <div className="mx-auto flex w-full max-w-6xl flex-col gap-8 px-4 py-8 sm:px-6 lg:px-8">
      ...
      {restaurants.length === 0 ? (
        <section className="rounded-[1.5rem] border border-dashed border-orange-300 bg-white p-8 text-center">
            ...
            >
              ...
              <div className="space-y-4 p-5">
                ...
                <div className="flex items-center justify-between text-sm text-[#8d5637]">
                  <span>{restaurant.availability.availableFulfilmentModes.join(' · ') || 'Tijdelijk geen fulfilment'}</span>
                  <span>{restaurant.availability.acceptsOrders ? 'Bekijk menu' : 'Bekijk beschikbaarheid'}</span>
                </div>
              </div>
            </Link>
          ))}
